...
\begin{frame}
    \frametitle{Direct-search methods in unconstrained optimization}

    \begin{block}{}
        Direct-search methods \alert{sample}~$\obj$ around the current iterate and choose the next iterate among the sampled points based on \alert{simple comparisons}.
    \end{block}
\end{frame}

\begin{frame}
    \frametitle{Line-search methods in unconstrained optimization}
\end{frame}
